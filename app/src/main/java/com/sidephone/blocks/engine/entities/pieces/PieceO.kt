...
class PieceO : Piece() {
	...
	override fun rotateClockwise(heapBlocks: List<Block>) {} // this piece does not rotate, so skip unnecessary calculations
	override fun rotateCounterClockwise(heapBlocks: List<Block>) {} // this piece does not rotate, so skip unnecessary calculations
